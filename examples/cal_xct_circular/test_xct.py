...
# bpick_list = [[nv_fi-1,nv_fi],[nv_fi,nv_fi + 1]]
...
vmtcls = Vmtxel(vmtseedname=vmtseedname, mffile=fname1)
hbxct = Xct(fname=fname_xct, gaugecls=gfield, vmtcls=vmtcls, deg_list=[[0,1],])
